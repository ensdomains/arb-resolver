...
async function main() {
  ...
  const ArbitrumResolver = await l2ethers.getContractFactory("ArbitrumResolver");
  console.log(3)
  ...
  console.log(16)
  const stub = await ArbitrumResolverStub.deploy(OVM_ADDRESS_MANAGER, "http://localhost:8081/query", resolver.address);
  console.log(17)
  await stub.deployed();
  console.log(18)
